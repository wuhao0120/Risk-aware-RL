...
KEY_METRICS: Tuple[str, ...] = (
    ...
    # QCPO_refs状态cost分布/quantile-GAE信用；action-CDF仍保留同批对照。
    "advantage/risk_source_is_state_quantile_gae",
    "advantage/risk_action_cdf_blended_std",
    "advantage/cost_state_raw_mean",
    "advantage/cost_state_raw_std",
    "advantage/cost_state_actor_std",
    "advantage/cost_state_tail_std",
    "advantage/cost_state_behavior_mean",
    "advantage/cost_state_target_mean",
    "advantage/cost_state_outage_label_correlation",
    "critic/cost_state_value_loss",
    "critic/cost_state_quantile_loss",
    "critic/cost_state_mean_loss",
    "critic/cost_state_prediction_mean",
    "critic/cost_state_prediction_std",
    "critic/cost_state_target_mean",
    "critic/cost_state_mean_target_mean",
    "critic/cost_state_mean_abs_error",
    "critic/cost_state_crossing_fraction",
    "critic/cost_state_grad_norm",
    "critic/cost_state_grad_clip_fraction",
    "critic/cost_state_aux_body_grad_norm",
    "critic/cost_state_aux_lstm_grad_norm",
    "critic/cost_state_aux_head_grad_norm",
    "critic/cost_state_joint_body_grad_norm",
    "critic/cost_state_joint_lstm_grad_norm",
    "critic/cost_state_joint_head_grad_norm",
    "debug/cost_actor_advantage_is_state_quantile_gae",
    "debug/cost_state_gradient_is_head_only",
    "debug/cost_state_gradient_is_shared_backbone",
    "debug/cost_state_value_cost_scale",
    "debug/cost_state_gae_lambda",
    "debug/cost_state_discount",
    "debug/cost_state_target_index",
    "debug/cost_state_tail_index",
    ...
    # LOO 轨迹基线诊断：均值应等于批次 outage，标准差应按 1/(B-1) 缩小。
    "advantage/risk_mc_baseline_mean",
    "advantage/risk_mc_baseline_std",
    "advantage/risk_mc_baseline_is_leave_one_out",
    "advantage/risk_mc_correction_coef",
    "advantage/risk_mc_balance_scale",
    "advantage/risk_mc_critic_scale_reference",
    "advantage/risk_mc_residual_scale_reference",
    "advantage/risk_mc_correction_to_critic_std_ratio",
    "norm/risk_critic_sigma_ema",
    "norm/risk_mc_residual_sigma_ema",
    ...
    "ppo/early_stop",
    "ppo/update_applied",
    # 当一次 rollout 被拆成多个独立 Adam step 时，保留各 optimizer probe 的聚合量。
    "ppo/optimizer_approx_kl_mean",
    "ppo/optimizer_approx_kl_max",
    "ppo/optimizer_clip_fraction_mean",
    "ppo/optimizer_clip_fraction_max",
    "ppo/optimizer_ratio_std_mean",
    "ppo/optimizer_ratio_std_max",
    "ppo/optimizer_probe_count",
    ...
    "training/actor_lr",
    # 显式记录批处理拆分和真实 optimizer step 数，避免只比较 nominal update 次数。
    "training/optimizer_minibatch_trajectories",
    "training/optimizer_minibatch_count",
    "training/critic_optimizer_steps_configured",
    "training/actor_optimizer_steps_configured",
    "training/critic_optimizer_steps_per_iteration",
    "training/actor_optimizer_steps_per_event",
    "debug/cost_actor_mc_baseline_is_leave_one_out",

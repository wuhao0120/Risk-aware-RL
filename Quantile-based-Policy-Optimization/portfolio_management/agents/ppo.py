...
class PPO(object):
    ...
    def __init__(self, args, env):
        ...
        self.warm_up(5 * self.est_interval)
    ...
    def warm_up(self, max_episode):
        ...
        a = np.mean(disc_epi_rewards, axis=0)
        self.memory.clear()
        self.writer.add_scalar('disc_reward/aver_reward', a, 0)
        self.writer.add_scalar('disc_reward/quantile_reward', q, 0)
        ...
        for i_episode in range(0,self.max_episode,self.workers):
            ...
            while True:
                ...
                if done[0]:
                    ...
                    last_value = self.critic(state).detach().data.cpu().numpy()
